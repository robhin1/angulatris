setTimeout(function(){
  ...
  $(function () {
      ...
      var contentHeight = pageHeight,//document.body.scrollHeight (for some reason this value used to give a value similar to pageHeight but now the value is way bigger (at least in my old phone))
